...
<head>
    ...
    <title>Login | Substack News</title>
    ...
    <div
        ...
        <div
            ...
            <div class="text-center">
                ...
                <h1 class="mt-2 text-2xl font-semibold text-white">Masuk ke dashboard</h1>
                <p class="mt-2 text-sm text-slate-400">Login dengan nama lengkap / username dan password.</p>
            </div>
            ...
            <p class="mt-6 text-center text-sm text-slate-500">
                Belum punya akun?
                <a href="/register" class="ml-1 text-sky-400 transition hover:text-sky-300">Daftar</a>
            </p>
        </div>
    </div>
</body>
